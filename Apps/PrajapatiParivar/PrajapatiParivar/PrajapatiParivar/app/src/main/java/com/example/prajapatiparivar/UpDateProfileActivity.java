...
public class UpDateProfileActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    String userName, mobile, address, moshad, shashri, study, midUpDate;
    private Button btnSubmit;
    private ImageView imageview;
    private int mYear, mMonth, mDay;
    Bitmap bitmap;
    private static final int READ_REQUEST_CODE = 777;
    String Sname, Sbod, Sstudy, SmaridStatus, Spiyar, Smoshad, SboladGroup, Smobile, Saddress, Simg;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (bundle != null) {
            Simg = bundle.getString("Simg");

            Sname = bundle.getString("Sname");
            Smobile = bundle.getString("Smobile");
            Saddress = bundle.getString("Saddress");
            Smoshad = bundle.getString("Smoshad");
            Spiyar = bundle.getString("Spiyar");
            Sstudy = bundle.getString("Sstudy");
            Sbod = bundle.getString("Sbod");
            SmaridStatus = bundle.getString("SmaridStatus");
            SboladGroup = bundle.getString("SboladGroup");
            midUpDate = bundle.getString("midUpDate");
        }
        Log.d("0000", "onCreate: " + midUpDate + "  " + Sname + "  " + Smobile + "  " + Smoshad + "  " + Spiyar + "  " + Sstudy + "  " + Sbod + "  " + SmaridStatus + "  " + SboladGroup + "  " + Saddress);
        ...
        Picasso.with(this).load(IMG_URL_MOBILE+Simg)
                .placeholder(R.drawable.usericon)
                .error(R.drawable.usericon)
                .noFade().into(imageview);

/*
        Glide.with(getApplicationContext()).load(IMG_URL_MOBILE+Simg)
                .thumbnail(0.5f)
        ...
        edtUserName.setText(Sname);
        edtmobile.setText(Smobile);
        edtAddress.setText(Saddress);
        edtmoshad.setText(Smoshad);
        edtshsari.setText(Spiyar);
        edtstudy.setText(Sstudy);
        tvBod.setText(Sbod);
...
// Check which radio button was clicked
        switch (view.getId()) {
            case R.id.rbUnmarid:
                if (checked)
                    userGender = "અપરણીત";///"અપરણીત";
                break;
            case R.id.rbMarid:
                if (checked)
                    userGender = "પરણીત";//"પરણીત";
                break;
        }
...
//=========================================================================================================================
    ...
    private void apiCalling() {
        ...
        Log.d("imgNotFound", "apiCalling: "+img);
        //  String userName = edtUserName.getText().toString();
        Call<ResponseUpDateProfile> call = apiService.getUpdateUserProfile(img, main_mamber_id, famili_id, userName, item0, userGender, tvBod.getText().toString(), study, moshad, shashri, item1, address, mobile, midUpDate);
        ...
        call.enqueue(new Callback<ResponseUpDateProfile>() {
            ...
            public void onResponse(Call<ResponseUpDateProfile> call, Response<ResponseUpDateProfile> response) {
                ...
                if (response != null && response.isSuccessful()) {
                    startActivity(new Intent(UpDateProfileActivity.this, UpDateDirectoryActivity.class));
                    Toast.makeText(UpDateProfileActivity.this, "Data Updated Successfully  ", Toast.LENGTH_LONG).show();
                }
            }
